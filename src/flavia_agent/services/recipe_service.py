...
from ..exceptions import FlaviaException, RecipeGenerationError
...
class RecipeService:
    ...
    async def suggest_recipe_with_sales(self, 
        ...
        try:
            ...
            # 5. FlaviaAgentでレシピ生成
            recipe_response = await self.flavia_agent.generate_response_async(
                integrated_prompt
            )
...
"""
            ...
            # レシピ生成
            response = self.flavia_agent.generate_response(prompt)
    ...
    def process_webfetch_result(self, webfetch_content: str, url: str, 
        ...
        try:
            ...
            # レシピ生成
            recipe_response = self.flavia_agent.generate_response(integrated_prompt)
